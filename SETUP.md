...
- Coordinator-ul aduce toate datele per POD: detalii contract, citiri contor, arhivă, întreruperi, smart meter, date furnizor, valori instantanee
- Senzorii și butoanele sunt create automat — câte un device per POD cu toți senzorii și butoanele aferenți
- Senzorii de producție apar doar pentru POD-uri de tip prosumer
- Senzorii Smart Meter și senzorii de valori instantanee apar doar pentru POD-uri cu contor inteligent
- Butonul de actualizare valori instantanee apare doar pentru POD-uri cu contor inteligent
- Datele furnizorului apar pentru **TOATE POD-urile**
- Apăsarea butonului de actualizare forțează reîncetosirea datelor instantanee de la contor. Poți crea o automatizare pentru a apăsa butonul la intervale regulate (ex: la fiecare oră sau la 15 minute) pentru monitorizare în timp real
